...
package io.github.android.qrcodelib.zxing.view;
...
import io.github.android.qrcodelib.zxing.camera.CameraManager;
...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, io.github.android.qrcodelib.R.styleable.qr_ViewfinderView);
        angleColor = typedArray.getColor(io.github.android.qrcodelib.R.styleable.qr_ViewfinderView_qr_angleColor, Color.WHITE);
        hint = typedArray.getString(io.github.android.qrcodelib.R.styleable.qr_ViewfinderView_qr_hint);
        hintColor = typedArray.getColor(io.github.android.qrcodelib.R.styleable.qr_ViewfinderView_qr_textHintColor, Color.GRAY);
        errorHint = typedArray.getString(io.github.android.qrcodelib.R.styleable.qr_ViewfinderView_qr_errorHint);
        errorHintColor = typedArray.getColor(io.github.android.qrcodelib.R.styleable.qr_ViewfinderView_qr_textErrorHintColor, Color.WHITE);
        showPossiblePoint = typedArray.getBoolean(io.github.android.qrcodelib.R.styleable.qr_ViewfinderView_qr_showPossiblePoint, false);

        RECT_OFFSET_X = typedArray.getInt(io.github.android.qrcodelib.R.styleable.qr_ViewfinderView_qr_offsetX, 0);
        RECT_OFFSET_Y = typedArray.getInt(io.github.android.qrcodelib.R.styleable.qr_ViewfinderView_qr_offsetY, 0);
        ...
        maskColor = resources.getColor(io.github.android.qrcodelib.R.color.viewfinder_mask);
        resultColor = resources.getColor(io.github.android.qrcodelib.R.color.result_view);
        frameColor = resources.getColor(io.github.android.qrcodelib.R.color.viewfinder_frame);
        laserColor = resources.getColor(io.github.android.qrcodelib.R.color.viewfinder_laser);
        resultPointColor = resources.getColor(io.github.android.qrcodelib.R.color.possible_result_points);
        scannerAlpha = 0;
